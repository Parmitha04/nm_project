    ...
    <div className="landingPage">
        <div className="landingHero">
          ...
          <div className="landingHero-title">
            <h1 className="banner-h1">Explore the Skies , Your Journey Begins Here!</h1>
            <p className="banner-p">Turn your travel dreams into reality—book flights to destinations that promise memories you will treasure forever.</p>     
          </div>
